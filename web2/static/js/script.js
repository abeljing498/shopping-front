(function ($) {
    ...
    if ($('.ecm-site-header .navigation').length) {
        cloneNavForSticyMenu($('.ecm-site-header .navigation'), "sticky-header");
    }
    ...
    function stickyMenu($targetMenu, $toggleClass) {
        ...
        var mainMenuTop = $('.ecm-site-header .navigation');
    ...
    /*------------------------------------------
        = Testimonial SLIDER
    -------------------------------------------*/
    if ($(".ecm-testimonial-wrap").length) {
        $(".ecm-testimonial-wrap").owlCarousel({
            autoplay: false,
            smartSpeed: 300,
            margin: 20,
            loop: true,
    ...
    /*------------------------------------------
        = Testimonial SLIDER
    -------------------------------------------*/
    if ($(".ecm-happy-client-slide").length) {
        $(".ecm-happy-client-slide").owlCarousel({
            autoplay: true,
            smartSpeed: 300,
            margin: 0,
            loop: true,
    ...
    $(window).on("scroll", function () {
        ...
        if ($(".ecm-site-header").length) {
            stickyMenu($('.ecm-site-header .navigation'), "sticky-on");
        }
